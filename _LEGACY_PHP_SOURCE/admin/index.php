            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Gestiona los usuarios</h6>
                        <a class="collapse-item" href="crear_usuario.php">Crear/Modificar</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <p><i class="fa-solid fa-chevron-left"></i> Horas Extras <i class="fa-solid fa-chevron-right"></i></p>
                    ...
                    <div class="form-floating">
                        ...
                        <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                            ...
                            <option selected value="1">Este mes</option>
                            <option value="2">Este año</option>
                            <option value="3">Todo el tiempo</option>
                        </select>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">CIERRE (4/7)
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">57.14%</div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                                            style="width: 57.14%" aria-valuenow="50" aria-valuemin="0"
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Historico de Horas Trabajadas</h6>
